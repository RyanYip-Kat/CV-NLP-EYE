...
class VRBot(nn.Module):
    def __init__(self,
        ...
        self.intention_embedding = nn.Linear(TO.n_intention, hidden_dim)
    ...
    def forward_train(self, pv_state, pv_hidden, pv_r_u, pv_r_u_len,
        ...
        #print(hidden4action.shape)
        #print(state_index.shape)
        #print(gth_intention.shape)
        #print(pv_r_u_enc4action.shape)
        #print(pv_r_u_len)
        #print(gth_action.shape)
