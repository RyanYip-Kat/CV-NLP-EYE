...
def config():
    ...
    parser.add_argument("--add_action",action="store_true")
    parser.add_argument("--n_intention",type=int,default=4,help="number of intention type")
    ...
    TO.update("epoch",args.max_epoch)
    TO.update("add_state",args.add_state)
    TO.update("add_action",args.add_action)
    TO.update("n_intention",args.n_intention)
