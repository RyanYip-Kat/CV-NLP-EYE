...
def parse_args():
    ...
    # data
    parser.add_argument('--img_size',type=int,default=None,help="resize image size if not None")
    ...
    parser.add_argument('--train_patch_height', default=64,type=int)
    parser.add_argument('--train_patch_width', default=64,type=int)
