...
def get_data(data_path,split="train",disease="EX",outdir="data_path_list/YanQD"):
    anno_path = join(data_path,"annotations1",split,disease)
    ...
    img_files =[x+".jpeg" for x in anno_names]
...
if __name__=="__main__":
    data_path = "/path/VesselSeg-datasets/macular/"
    split = "train"
    disease = "macular" 
    get_data(data_path,split,disease,"data_path_list/macular")
